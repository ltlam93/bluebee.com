...
define("EW_PROJECT_NAME", "bluebeeprj", TRUE); // Project name
...
define("EW_RANDOM_KEY", '109B2Zjj6Es6T7Q7', TRUE); // Random key for encryption
...
// Security
define("EW_ADMIN_USER_NAME", "assmin", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "bluebee2014", TRUE); // Administrator password

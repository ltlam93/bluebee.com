...
$tbl_lesson_doc_edit = NULL; // Initialize page object first

class ctbl_lesson_doc_edit extends ctbl_lesson_doc {
	...
	// Page object name
	var $PageObjName = 'tbl_lesson_doc_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "")
			$this->Page_Terminate("tbl_lesson_doclist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($tbl_lesson_doc_edit)) $tbl_lesson_doc_edit = new ctbl_lesson_doc_edit();

// Page init
$tbl_lesson_doc_edit->Page_Init();

// Page main
$tbl_lesson_doc_edit->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var tbl_lesson_doc_edit = new ew_Page("tbl_lesson_doc_edit");
tbl_lesson_doc_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = tbl_lesson_doc_edit.PageID; // For backward compatibility

// Form object
var ftbl_lesson_docedit = new ew_Form("ftbl_lesson_docedit");

// Validate form
ftbl_lesson_docedit.Validate = function(fobj) {
...
ftbl_lesson_docedit.Form_CustomValidate =  
...
ftbl_lesson_docedit.ValidateRequired = true;
<?php } else { ?>
ftbl_lesson_docedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftbl_lesson_docedit.Lists["x_lesson_id"] = {"LinkField":"x_lesson_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_lesson_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
ftbl_lesson_docedit.Lists["x_doc_id"] = {"LinkField":"x_doc_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_doc_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $tbl_lesson_doc->TableCaption() ?></span></p>
...
<?php $tbl_lesson_doc_edit->ShowPageHeader(); ?>
<?php
$tbl_lesson_doc_edit->ShowMessage();
?>
<form name="ftbl_lesson_docedit" id="ftbl_lesson_docedit" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="tbl_lesson_doc">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_tbl_lesson_docedit" class="ewTable">
...
<?php echo $tbl_lesson_doc->id->EditValue ?></span>
<input type="hidden" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($tbl_lesson_doc->id->CurrentValue) ?>">
</span><?php echo $tbl_lesson_doc->id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ftbl_lesson_docedit.Lists["x_lesson_id"].Options = <?php echo (is_array($tbl_lesson_doc->lesson_id->EditValue)) ? ew_ArrayToJson($tbl_lesson_doc->lesson_id->EditValue, 1) : "[]" ?>;
</script>
...
<script type="text/javascript">
var oas = new ew_AutoSuggest("x_doc_id", ftbl_lesson_docedit, false, EW_AUTO_SUGGEST_MAX_ENTRIES);
...
ftbl_lesson_docedit.AutoSuggests["x_doc_id"] = oas;
</script>
...
<script type="text/javascript">
ftbl_lesson_docedit.Init();
</script>
<?php
$tbl_lesson_doc_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tbl_lesson_doc_edit->Page_Terminate();
?>

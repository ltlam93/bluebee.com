...
$tbl_subject_group_view = NULL; // Initialize page object first

class ctbl_subject_group_view extends ctbl_subject_group {
	...
	// Page object name
	var $PageObjName = 'tbl_subject_group_view';
...
// Create page object
if (!isset($tbl_subject_group_view)) $tbl_subject_group_view = new ctbl_subject_group_view();

// Page init
$tbl_subject_group_view->Page_Init();
...
// Page object
var tbl_subject_group_view = new ew_Page("tbl_subject_group_view");
tbl_subject_group_view.PageID = "view"; // Page ID
var EW_PAGE_ID = tbl_subject_group_view.PageID; // For backward compatibility

// Form object
var ftbl_subject_groupview = new ew_Form("ftbl_subject_groupview");

// Form_CustomValidate event
ftbl_subject_groupview.Form_CustomValidate =  
...
ftbl_subject_groupview.ValidateRequired = true;
<?php } else { ?>
ftbl_subject_groupview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftbl_subject_groupview.Lists["x_subject_type_id"] = {"LinkField":"x_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_subject_type_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
ftbl_subject_groupview.Lists["x_faculty_id"] = {"LinkField":"x_faculty_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_faculty_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
ftbl_subject_groupview.Lists["x_dept_id"] = {"LinkField":"x_dept_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_dept_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($tbl_subject_group_view->AddUrl <> "") { ?>
<a href="<?php echo $tbl_subject_group_view->AddUrl ?>" id="a_AddLink" class="ewLink"><?php echo $Language->Phrase("ViewPageAddLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($tbl_subject_group_view->EditUrl <> "") { ?>
<a href="<?php echo $tbl_subject_group_view->EditUrl ?>" id="a_EditLink" class="ewLink"><?php echo $Language->Phrase("ViewPageEditLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
<?php if ($tbl_subject_group_view->CopyUrl <> "") { ?>
<a href="<?php echo $tbl_subject_group_view->CopyUrl ?>" id="a_CopyLink" class="ewLink"><?php echo $Language->Phrase("ViewPageCopyLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
<?php if ($Security->IsLoggedIn()) { ?>
...
<table id="tbl_tbl_subject_groupview" class="ewTable">
...
<?php echo $tbl_subject_group->id->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $tbl_subject_group->subject_type_id->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $tbl_subject_group->faculty_id->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $tbl_subject_group->dept_id->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<?php echo $tbl_subject_group->subject_group_name->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
...
<span<?php echo $tbl_subject_group->subject_group_info->ViewAttributes() ?>>
<?php echo $tbl_subject_group->subject_group_info->ViewValue ?></span>
</span></td>
	</tr>
<?php } ?>
</table>
...
<br>
<script type="text/javascript">
ftbl_subject_groupview.Init();
</script>
<?php
$tbl_subject_group_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($tbl_subject_group->Export == "") { ?>

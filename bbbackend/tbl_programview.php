	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["program_id"] <> "") {
				...
				$sReturnUrl = "tbl_programlist.php"; // Return to list
			}
...
<a href="<?php echo $tbl_program_view->DeleteUrl ?>" id="a_DeleteLink" class="ewLink"><?php echo $Language->Phrase("ViewPageDeleteLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
</p>

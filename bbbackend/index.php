...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("tbl_subject_facultylist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("tbl_subject_grouplist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("tbl_subject_group_typelist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("tbl_subject_teacherlist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("tbl_subject_typelist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("tbl_teacherlist.php");
		if ($Security->IsLoggedIn())

...
class ctbl_subject_faculty_list extends ctbl_subject_faculty {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_tbl_subject_faculty\" href=\"javascript:void(0);\" onclick=\"ew_EmailDialogShow({lnk:'emf_tbl_subject_faculty',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.ftbl_subject_facultylist,sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
<?php if ($Security->IsLoggedIn()) { ?>
<a class="ewGridLink" href="" onclick="ew_SubmitSelected(document.ftbl_subject_facultylist, '<?php echo $tbl_subject_faculty_list->MultiDeleteUrl ?>', ewLanguage.Phrase('DeleteMultiConfirmMsg'));return false;"><?php echo $Language->Phrase("DeleteSelectedLink") ?></a>&nbsp;&nbsp;
<?php } ?>
<?php } ?>
</span>
</div>

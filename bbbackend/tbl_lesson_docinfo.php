...
//
// Table class for tbl_lesson_doc
//
class ctbl_lesson_doc extends cTable {
	var $id;
	var $lesson_id;
	var $doc_id;
	var $active;
	...
	function __construct() {
		...
		$this->TableVar = 'tbl_lesson_doc';
		$this->TableName = 'tbl_lesson_doc';
		...
		// id
		$this->id = new cField('tbl_lesson_doc', 'tbl_lesson_doc', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// lesson_id
		$this->lesson_id = new cField('tbl_lesson_doc', 'tbl_lesson_doc', 'x_lesson_id', 'lesson_id', '`lesson_id`', '`lesson_id`', 3, -1, FALSE, '`lesson_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->lesson_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['lesson_id'] = &$this->lesson_id;

		// doc_id
		$this->doc_id = new cField('tbl_lesson_doc', 'tbl_lesson_doc', 'x_doc_id', 'doc_id', '`doc_id`', '`doc_id`', 3, -1, FALSE, '`doc_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->doc_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['doc_id'] = &$this->doc_id;

		// active
		$this->active = new cField('tbl_lesson_doc', 'tbl_lesson_doc', 'x_active', 'active', '`active`', '`active`', 3, -1, FALSE, '`active`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`tbl_lesson_doc`";
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("tbl_lesson_docview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "tbl_lesson_docadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("tbl_lesson_docedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("tbl_lesson_docadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tbl_lesson_docdelete.php", $this->UrlParm());
	}

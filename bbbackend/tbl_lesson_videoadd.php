...
$tbl_lesson_video_add = NULL; // Initialize page object first

class ctbl_lesson_video_add extends ctbl_lesson_video {
	...
	// Page object name
	var $PageObjName = 'tbl_lesson_video_add';
	...
	function LoadDefaultValues() {
		...
		$this->video_link->CurrentValue = NULL;
		$this->video_link->OldValue = $this->video_link->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// video_link
		$this->video_link->SetDbValueDef($rsnew, $this->video_link->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($tbl_lesson_video_add)) $tbl_lesson_video_add = new ctbl_lesson_video_add();

// Page init
$tbl_lesson_video_add->Page_Init();

// Page main
$tbl_lesson_video_add->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var tbl_lesson_video_add = new ew_Page("tbl_lesson_video_add");
tbl_lesson_video_add.PageID = "add"; // Page ID
var EW_PAGE_ID = tbl_lesson_video_add.PageID; // For backward compatibility

// Form object
var ftbl_lesson_videoadd = new ew_Form("ftbl_lesson_videoadd");

// Validate form
ftbl_lesson_videoadd.Validate = function(fobj) {
...
ftbl_lesson_videoadd.Form_CustomValidate =  
...
ftbl_lesson_videoadd.ValidateRequired = true;
<?php } else { ?>
ftbl_lesson_videoadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftbl_lesson_videoadd.Lists["x_lesson_id"] = {"LinkField":"x_lesson_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_lesson_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $tbl_lesson_video->TableCaption() ?></span></p>
...
<?php $tbl_lesson_video_add->ShowPageHeader(); ?>
<?php
$tbl_lesson_video_add->ShowMessage();
?>
<form name="ftbl_lesson_videoadd" id="ftbl_lesson_videoadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="tbl_lesson_video">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_tbl_lesson_videoadd" class="ewTable">
...
<script type="text/javascript">
ftbl_lesson_videoadd.Lists["x_lesson_id"].Options = <?php echo (is_array($tbl_lesson_video->lesson_id->EditValue)) ? ew_ArrayToJson($tbl_lesson_video->lesson_id->EditValue, 1) : "[]" ?>;
</script>
...
<script type="text/javascript">
ftbl_lesson_videoadd.Init();
</script>
<?php
$tbl_lesson_video_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tbl_lesson_video_add->Page_Terminate();
?>

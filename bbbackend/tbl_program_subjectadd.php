...
$tbl_program_subject_add = NULL; // Initialize page object first

class ctbl_program_subject_add extends ctbl_program_subject {
	...
	// Page object name
	var $PageObjName = 'tbl_program_subject_add';
...
// Create page object
if (!isset($tbl_program_subject_add)) $tbl_program_subject_add = new ctbl_program_subject_add();

// Page init
$tbl_program_subject_add->Page_Init();

// Page main
$tbl_program_subject_add->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var tbl_program_subject_add = new ew_Page("tbl_program_subject_add");
tbl_program_subject_add.PageID = "add"; // Page ID
var EW_PAGE_ID = tbl_program_subject_add.PageID; // For backward compatibility

// Form object
var ftbl_program_subjectadd = new ew_Form("ftbl_program_subjectadd");

// Validate form
ftbl_program_subjectadd.Validate = function(fobj) {
...
ftbl_program_subjectadd.Form_CustomValidate =  
...
ftbl_program_subjectadd.ValidateRequired = true;
<?php } else { ?>
ftbl_program_subjectadd.ValidateRequired = false; 
<?php } ?>
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $tbl_program_subject->TableCaption() ?></span></p>
...
<?php $tbl_program_subject_add->ShowPageHeader(); ?>
<?php
$tbl_program_subject_add->ShowMessage();
?>
<form name="ftbl_program_subjectadd" id="ftbl_program_subjectadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="tbl_program_subject">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_tbl_program_subjectadd" class="ewTable">
...
<script type="text/javascript">
ftbl_program_subjectadd.Init();
</script>
<?php
$tbl_program_subject_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tbl_program_subject_add->Page_Terminate();
?>

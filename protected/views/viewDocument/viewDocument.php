                        ...
                        <div class="l-content">
                            ...
                            if ($detail->doc_type == 2) {
                                ...
                                if ($detail->doc_type == 1) {
                                    echo '<div style="text-align:center"><img style="width: auto; height: auto; margin: 0 auto; " align = "middle" src="' . $detail->doc_path . '" /></div></br></br>' . '<a href="' . $detail->doc_path . '"' . 'download="' . $detail->doc_name . '" style = "font-size:25px;"><button class="g-btn type_primary size_small">Download</button></a>';
                                } else {

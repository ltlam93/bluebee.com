...
<div class="<?php if (Yii::app()->session["user_id"] != "")
    ...
    $(document).ready(function() {
        ...
        $('.cancel_file').click(function(event) {
            ...
            <form method="POST" action="<?php echo Yii::app()->createUrl('lab/upload') ?>" enctype="multipart/form-data" id="formscribd" data-type="iframe" data-success-event="upload-doc-success" data-load-event="upload-doc-load" data-send-event="upload-doc-send">

...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2014 at 05:31 AM
...
(45, 'Xác suất thống kê ', 'MAT1101', '1', NULL, 3, NULL, 3, '30 - 15', NULL, '<p>\r\n	Sinh vi&ecirc;n nắm được kh&aacute;i niệm về x&aacute;c suất, c&aacute;c quy tắc t&iacute;nh x&aacute;c suất v&agrave; c&aacute;c ứng dụng; kh&aacute;i niệm về đại lượng ngẫu nhi&ecirc;n, c&aacute;c đặc trưng của đại lượng ngẫu nhi&ecirc;n v&agrave; một số ph&acirc;n bố thường gặp trong thực tế; c&aacute;c kiến thức cơ bản về l&yacute; thuyết mẫu, thống k&ecirc; m&ocirc; tả; c&aacute;c vấn đề ước lượng khoảng, kiểm định giả thiết, tương quan v&agrave; hồi quy; sinh vi&ecirc;n hiểu được vai tr&ograve; v&agrave; ứng dụng của X&aacute;c suất thống k&ecirc; trong c&aacute;c ng&agrave;nh khoa học kh&aacute;c cũng như trong cuộc sống.</p>', NULL, NULL, 1, 1, '<p>\r\n	Nội dung m&ocirc;n học gồm 2 phần ch&iacute;nh: phần X&aacute;c suất v&agrave; phần Thống k&ecirc;. Phần x&aacute;c suất cung cấp cho sinh vi&ecirc;n c&aacute;c kiến thức về ph&eacute;p thử ngẫu nhi&ecirc;n, biến cố, x&aacute;c suất của biến cố, c&aacute;c phương ph&aacute;p t&iacute;nh x&aacute;c suất, đại lượng ngẫu nhi&ecirc;n v&agrave; ph&acirc;n phối của n&oacute;, c&aacute;c đặc trưng của đại lượng ngẫu nhi&ecirc;n, một số ph&acirc;n phối thường gặp trong thực tế. Phần thống k&ecirc; giới thiệu cho sinh vi&ecirc;n c&aacute;c b&agrave;i to&aacute;n cơ bản của thống k&ecirc; v&agrave; c&aacute;ch giải quyết c&aacute;c b&agrave;i to&aacute;n n&agrave;y như b&agrave;i to&aacute;n ước lượng khoảng, b&agrave;i to&aacute;n kiểm định giả thiết, b&agrave;i to&aacute;n tương quan v&agrave; hồi quy&hellip;</p>', 1);
INSERT INTO `tbl_subject` (`subject_id`, `subject_name`, `subject_code`, `subject_active`, `subject_university`, `subject_type`, `subject_year`, `subject_credits`, `subject_credit_hour`, `subject_requirement`, `subject_target`, `subject_info`, `subject_test`, `subject_faculty`, `subject_dept`, `subject_content`, `subject_general_faculty_id`) VALUES
(46, 'Toán trong công nghệ', 'ELT2029', '1', NULL, 3, NULL, 3, '45', NULL, '<p>\r\n	M&ocirc;n học n&agrave;y trang bị một số kiến thức to&aacute;n học nền tảng được sử dụng rộng r&atilde;i trong lĩnh vực Điện tử - Viễn th&ocirc;ng (ĐTVT), cụ thể l&agrave; giải t&iacute;ch phức, x&aacute;c suất v&agrave; thống k&ecirc;. B&ecirc;n cạnh, sinh vi&ecirc;n sẽ được giải th&iacute;ch mối li&ecirc;n hệ sự li&ecirc;n hệ giữa c&aacute;c kiến thức to&aacute;n học n&agrave;y với bản chất vật l&yacute; trong c&aacute;c hệ thống ĐTVT th&ocirc;ng qua một số ứng dụng cụ thể. Sinh vi&ecirc;n c&oacute; kỹ năng chứng minh v&agrave; giải quyết vấn đề để giải c&aacute;c b&agrave;i to&aacute;n. C&oacute; kỹ năng suy luận logic v&agrave; tổng hợp để li&ecirc;n hệ v&agrave; chuyển tải c&aacute;c vấn đề c&ocirc;ng nghệ ĐTVT đơn giản th&agrave;nh c&aacute;c b&agrave;i to&aacute;n tương ứng.</p>', NULL, NULL, 1, 1, '<p>\r\n	Bao gồm hai loại kiến thức to&aacute;n học chuy&ecirc;n s&acirc;u cho lĩnh vực Điện tử - Viễn th&ocirc;ng, l&agrave;: Giải t&iacute;ch phức v&agrave; X&aacute;c suất &ndash; Thống k&ecirc;. Về giải t&iacute;ch phức, m&ocirc;n học đề cập đến c&aacute;c vấn đề li&ecirc;n quan đến số phức, như: h&agrave;m giải t&iacute;ch, h&agrave;m cơ sở, t&iacute;ch ph&acirc;n phức, biểu diễn chuỗi của c&aacute;c h&agrave;m giải t&iacute;ch, c&aacute;c ph&eacute;p biến đổi. Về x&aacute;c suất &ndash; thống k&ecirc;, m&ocirc;n học bao gồm: c&aacute;c m&ocirc; h&igrave;nh x&aacute;c suất, c&aacute;c kh&aacute;i niệm cơ bản của l&yacute; thuyết x&aacute;c suất, biến ngẫu nhi&ecirc;n, đa biến ngẫu nhi&ecirc;n, v&agrave; qu&aacute; tr&igrave;nh ngẫu nhi&ecirc;n. K&egrave;m theo, m&ocirc;n học sẽ cung cấp một số ứng dụng th&ocirc;ng dụng của c&aacute;c kiến thức n&agrave;y trong c&aacute;c vấn đề kỹ thuật của lĩnh vực Điện tử - Viễn th&ocirc;ng.</p>', 1),
(47, 'Mạng máy tính', 'INT2209', '1', NULL, 4, NULL, 3, '30 - 15', NULL, '<p>\r\n	Hiểu được c&aacute;ch vận h&agrave;nh của Mạng m&aacute;y t&iacute;nh một c&aacute;ch tổng quan. Từ những nguy&ecirc;n l&yacute; cơ bản n&agrave;y, sinh vi&ecirc;n sẽ t&igrave;m hiểu c&aacute;ch thức mạng Internet ng&agrave;y nay được triển khai như thế n&agrave;o. Sinh vi&ecirc;n phải hiểu được kiến tr&uacute;c ph&acirc;n tầng, với m&ocirc; h&igrave;nh tham chiếu OSI v&agrave; m&ocirc; h&igrave;nh Internet. Hiểu được c&aacute;ch thức c&aacute;c ứng dụng cơ bản (Web, FTP, DNS, Instant Message) l&agrave;m việc như thế n&agrave;o, biết qua về lập tr&igrave;nh socket. Hiểu được giao thức giao vận UDP v&agrave; TCP. Hiểu được c&aacute;ch đ&aacute;nh địa chỉ IP v&agrave; giao thức IP. C&aacute;c giao thức định tuyến: RIP, OSPF, BGP. Cơ chế l&agrave;m việc của mạng cục bộ: c&ocirc;ng nghệ Ethernet, Hub, Bridge, Switch, mạng LAN kh&ocirc;ng d&acirc;y; sử dụng được một số lệnh cơ bản của Mạng như Ping, traceroute- ; sử dụng được một số lệnh cơ bản của FTP; sử dụng giao diện text để gửi v&agrave; nhận thư; sử dụng được phần mềm Ethereal để bắt v&agrave; ph&acirc;n t&iacute;ch c&aacute;c g&oacute;i tin ở c&aacute;c tầng kh&aacute;c nhau: HTTP, TCP, IP&hellip;; sử dụng được phần mềm Bosom Netsim để thiết lập v&agrave; chạy c&aacute;c cấu h&igrave;nh router.</p>', NULL, NULL, 1, 1, '<p>\r\n	M&ocirc;n học được chia th&agrave;nh 5 chương. Chương 1 giới thiệu chung về to&agrave;n bộ c&aacute;c phần, tr&igrave;nh b&agrave;y vị tr&iacute; của c&aacute;c phần, dịch vụ v&agrave; m&ocirc; h&igrave;nh Mạng. Tập trung v&agrave;o kh&aacute;i niệm ph&acirc;n tầng. Giới thiệu qua về M&ocirc; h&igrave;nh OSI v&agrave; M&ocirc; h&igrave;nh Internet. Chương 2 tr&igrave;nh b&agrave;y về Tầng Ứng dụng. Giới thiệu c&aacute;c y&ecirc;u cầu của c&aacute;c ứng dụng : t&iacute;nh tin cậy, khả năng đảm bảo băng th&ocirc;ng v&agrave; thời gian. Tr&igrave;nh b&agrave;y hai m&ocirc; h&igrave;nh ứng dụng v&agrave; c&aacute;c ứng dụng li&ecirc;n quan. M&ocirc; h&igrave;nh client-server với ứng dụng Web, truyền file, thư t&iacute;n điện tử (email), dich vụ t&ecirc;n miền (DNS). M&ocirc; h&igrave;nh đồng đẳng với ứng dụng Nhắn tin tức th&igrave; v&agrave; Chia sẻ file. Phần cuối tr&igrave;nh b&agrave;y c&aacute;ch ph&aacute;t triển ứng dụng với lập tr&igrave;nh socket. Chương 3 tr&igrave;nh b&agrave;y về tầng Giao vận. Phần đầu ti&ecirc;n giới thiệu về c&aacute;c dịch vụ Giao vận quan trọng nhất v&agrave; giao thức UDP. Phần thứ hai tr&igrave;nh b&agrave;y về nguy&ecirc;n tắc x&acirc;y dựng đường truyền tin cậy. Phần cuối c&ugrave;ng giới thiệu giao thức TCP v&agrave; c&aacute;ch thức triển khai t&iacute;nh tin cậy, điều khiển lưu lượng, kiểm so&aacute;t tắc nghẽn trong TCP. Chương 4 giới thiệu về tầng Mạng với hai m&ocirc; h&igrave;nh ch&iacute;nh : Chuyển mạch v&agrave; Chuyển g&oacute;i. Sau đ&oacute; giới thiệu về c&aacute;ch đ&aacute;nh địa chỉ IP v&agrave; giao thức IP. Phần sau tr&igrave;nh b&agrave;y c&aacute;c thuật to&aacute;n định tuyến, việc định tuyến ph&acirc;n cấp: nội miền (RIP, OSPF) v&agrave; li&ecirc;n miền (BGP). Phần cuối c&ugrave;ng tr&igrave;nh b&agrave;y về IPv6. Chương 5 tr&igrave;nh b&agrave;y về Tầng Li&ecirc;n kết dữ liệu với c&aacute;c dịch vụ quan trọng nhất. Sau đ&oacute; giới thiệu về c&ocirc;ng nghệ Ethernet, c&aacute;c thiết bị kết nối ở tầng Li&ecirc;n kết dữ liệu như Hub, Bridge, Switch; C&ocirc;ng nghệ kết nối LAN kh&ocirc;ng d&acirc;y.</p>', 1),
(48, 'Lập trình nâng cao', 'INT2202', '1', NULL, 5, NULL, 3, '30 - 15', NULL, '<p>\r\n	Hiểu c&aacute;c kh&aacute;i niệm v&agrave; biết vận dụng c&aacute;c kỹ thuật trong lập tr&igrave;nh để biểu diễn b&agrave;i to&aacute;n v&agrave; giải quyết b&agrave;i to&aacute;n bằng lập tr&igrave;nh; hiểu c&aacute;c kh&aacute;i niệm cơ bản trong lập tr&igrave;nh hướng đối tượng, c&oacute; khả năng lập tr&igrave;nh c&aacute;c b&agrave;i to&aacute;n cơ bản bằng lập tr&igrave;nh hướng đối tượng trong C++; c&oacute; khả năng lập tr&igrave;nh với nhiều loại cấu tr&uacute;c dữ liệu phức tạp v&agrave; c&aacute;c kỹ thuật kh&oacute;. C&aacute;c kiểu dữ liệu như X&acirc;u, Mảng nhiều chiều, Cấu tr&uacute;c v&agrave; Lớp. C&aacute;c kỹ thuật lập tr&igrave;nh kh&oacute; như h&agrave;m đệ qui, xử l&yacute; tr&ecirc;n x&acirc;u, x&acirc;y dựng lớp v&agrave; đối tượng, x&acirc;y dựng c&aacute;c h&agrave;m mẫu.&nbsp;</p>', NULL, NULL, 1, 1, '<p>\r\n	Cung cấp cho sinh vi&ecirc;n c&aacute;c kiến thức cơ bản v&agrave; n&acirc;ng cao về c&aacute;ch giải quyết c&aacute;c b&agrave;i to&aacute;n bằng lập tr&igrave;nh. Giới thiệu c&aacute;c kh&aacute;i niệm v&agrave; cấu tr&uacute;c lập tr&igrave;nh căn bản để giải quyết b&agrave;i to&aacute;n (minh hoạ tr&ecirc;n ng&ocirc;n ngữ C++): biến, kiểu dữ liệu, biểu thức, ph&eacute;p g&aacute;n, v&agrave;o ra dữ liệu đơn giản; c&aacute;c cấu tr&uacute;c lặp v&agrave; điều kiện, ph&acirc;n r&atilde; cấu tr&uacute;c; l&agrave;m việc với tệp; kh&aacute;i niệm h&agrave;m v&agrave; sử dụng h&agrave;m. Giới thiệu c&aacute;c kh&aacute;i niệm v&agrave; kỹ thuật n&acirc;ng cao trong lập tr&igrave;nh: l&agrave;m việc với dữ liệu c&oacute; cấu tr&uacute;c; kỹ thuật đệ qui; kiểu dữ liệu trừu tượng; khu&ocirc;n mẫu h&agrave;m; c&aacute;c kh&aacute;i niệm v&agrave; kỹ thuật cơ bản trong lập tr&igrave;nh hướng đối tượng; lập tr&igrave;nh tr&ecirc;n nhiều tệp. Thực h&agrave;nh tr&ecirc;n ng&ocirc;n ngữ lập tr&igrave;nh hướng đối tượng C++.</p>', NULL),
(49, 'Đồ họa máy tính', 'INT3403', '1', NULL, 5, NULL, 3, '30 - 15', NULL, '<p>\r\n	Hiểu c&aacute;c nguy&ecirc;n l&yacute; cơ bản của đồ họa m&aacute;y t&iacute;nh hiện đại; hiểu kiến thức h&igrave;nh học b&ecirc;n dưới c&aacute;c m&ocirc; h&igrave;nh 3 chiều; hiểu vấn đề hiệu năng khi vẽ c&aacute;c m&ocirc; h&igrave;nh 3D; c&oacute; thể x&acirc;y dựng một chương tr&igrave;nh hiển thị một cảnh 3 chiều sử dụng OpenGL v&agrave; C/C++; c&oacute; thể l&agrave;m hoạt h&igrave;nh c&aacute;c m&ocirc; h&igrave;nh 3D v&agrave; &aacute;p dụng &aacute;nh s&aacute;ch v&agrave; texture để tăng t&iacute;nh hiện thực&nbsp;</p>', NULL, NULL, 1, 1, '<p>\r\n	M&ocirc;n học giới thiệu c&aacute;c kiến thức cơ bản v&agrave; n&acirc;ng cao về c&aacute;c thuật to&aacute;n cơ bản của đồ họa m&aacute;y t&iacute;nh như thuật to&aacute;n vẽ đường thẳng, đường tr&ograve;n, quy tr&igrave;nh đồ họa m&aacute;y t&iacute;nh từ kh&acirc;u m&ocirc; h&igrave;nh h&oacute;a cho đến khi hiển thị được l&ecirc;n m&agrave;n h&igrave;nh, đồng thời giới thiệu một số thuật to&aacute;n trong quy tr&igrave;nh đ&oacute;; giới thiệu một số kiến thức cơ bản để lập tr&igrave;nh đồ họa tr&ecirc;n OpenGL.</p>', NULL),
(50, 'Lý thuyết thông tin', 'INT2044', '1', NULL, 5, NULL, 3, '45', NULL, '<p>\r\n	Hiểu c&aacute;c kh&aacute;i niệm cơ bản của l&yacute; thuyết th&ocirc;ng tin như entropy, th&ocirc;ng tin tương hỗ; c&oacute; thể vận dụng để giải c&aacute;c b&agrave;i to&aacute;n cần x&aacute;c định lượng tin; hiểu m&ocirc; h&igrave;nh truyền th&ocirc;ng theo quan điểm của Shannon; biết được ảnh hưởng của l&yacute; thuyết th&ocirc;ng tin trong c&aacute;c lĩnh vực như thống k&ecirc;, học m&aacute;y, kinh tế, v.v.</p>', NULL, NULL, 1, 1, '<p>\r\n	M&ocirc;n học n&agrave;y tập trung v&agrave;o định nghĩa v&agrave; h&agrave;m &yacute; của entropy, entropy tương đối, th&ocirc;ng tin tương hỗ, định l&yacute; m&atilde; h&oacute;a nguồn, v&agrave; định l&yacute; m&atilde; h&oacute;a k&ecirc;nh. B&ecirc;n cạnh đ&oacute; c&aacute;c kết quả to&aacute;n học của l&yacute; thuyết th&ocirc;ng tin cũng được giới thiệu, v&agrave; d&ugrave;ng l&agrave;m c&ocirc;ng cụ chứng minh nhiều định l&yacute; quan trọng. Trong qu&aacute; tr&igrave;nh học m&ocirc;n n&agrave;y, người học sẽ được kh&aacute;m ph&aacute; giới hạn cơ bản của biểu diễn v&agrave; giới hạn cơ bản của truyền th&ocirc;ng tin. C&aacute;c kiến thức về l&yacute; thuyết th&ocirc;ng tin cung cấp một nền tảng cho c&aacute;c nh&agrave; nghi&ecirc;n cứu trong c&aacute;c lĩnh vực như n&eacute;n dữ liệu, xử l&yacute; t&iacute;n hiệu, điều khiển, nhận dạng mẫu, v&agrave; học m&aacute;y thống k&ecirc;.</p>', NULL),
(51, 'Chuyên đề công nghệ', 'INT3414', '1', NULL, 5, NULL, 3, '30 - 15', NULL, '<p>\r\n	C&oacute; kiến thực thực h&agrave;nh v&agrave; ứng dụng được c&ocirc;ng nghệ được học; h&igrave;nh th&agrave;nh khả năng tự t&igrave;m hiểu, lựa chọn v&agrave; sử dụng c&ocirc;ng nghệ mới; ph&aacute;t triển kỹ năng l&agrave;m việc theo nh&oacute;m; c&oacute; hiểu biết ban đầu về mối quan hệ giữa c&ocirc;ng nghệ với c&aacute;c vấn đề li&ecirc;n quan trong cuộc sống.</p>', NULL, NULL, 1, 1, '<p>\r\n	M&ocirc;n học gi&uacute;p sinh vi&ecirc;n c&oacute; được kiến thức v&agrave; kỹ năng thực h&agrave;nh về một số c&ocirc;ng nghệ hiện đại v&agrave; th&ocirc;ng dụng trong C&ocirc;ng nghệ th&ocirc;ng tin. Đồng thời m&ocirc;n học cung cấp cho sinh vi&ecirc;n kiến thức li&ecirc;n quan tới c&ocirc;ng nghệ n&oacute;i chung như: khoa học v&agrave; c&ocirc;ng nghệ, v&ograve;ng đời c&ocirc;ng nghệ, vai tr&ograve; của nhu cầu v&agrave; của vốn trong ph&aacute;t triển c&ocirc;ng nghệ, ...</p>', NULL),
(52, '<p>\r\n	Chương tr&igrave;nh dịch</p>', 'INT3402', '1', NULL, 5, NULL, 3, '45', NULL, NULL, NULL, NULL, 1, 1, NULL, NULL);

...
$tbl_news_add = NULL; // Initialize page object first

class ctbl_news_add extends ctbl_news {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "tbl_newsview.php")
	...
	function LoadDefaultValues() {
		$this->news_university->CurrentValue = NULL;
		$this->news_university->OldValue = $this->news_university->CurrentValue;
		...
		$this->news_active->CurrentValue = NULL;
		$this->news_active->OldValue = $this->news_active->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// news_university
		$this->news_university->SetDbValueDef($rsnew, $this->news_university->CurrentValue, NULL, FALSE);

		// news_title
		$this->news_title->SetDbValueDef($rsnew, $this->news_title->CurrentValue, NULL, FALSE);

		// news_content
		$this->news_content->SetDbValueDef($rsnew, $this->news_content->CurrentValue, NULL, FALSE);

		// news_active
		$this->news_active->SetDbValueDef($rsnew, $this->news_active->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($tbl_news_add)) $tbl_news_add = new ctbl_news_add();

// Page init
$tbl_news_add->Page_Init();

// Page main
$tbl_news_add->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var tbl_news_add = new ew_Page("tbl_news_add");
tbl_news_add.PageID = "add"; // Page ID
var EW_PAGE_ID = tbl_news_add.PageID; // For backward compatibility

// Form object
var ftbl_newsadd = new ew_Form("ftbl_newsadd");

// Validate form
ftbl_newsadd.Validate = function(fobj) {
...
ftbl_newsadd.Form_CustomValidate =  
...
ftbl_newsadd.ValidateRequired = true;
<?php } else { ?>
ftbl_newsadd.ValidateRequired = false; 
<?php } ?>
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $tbl_news->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $tbl_news->getReturnUrl() ?>" id="a_GoBack" class="ewLink"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $tbl_news_add->ShowPageHeader(); ?>
<?php
$tbl_news_add->ShowMessage();
?>
<form name="ftbl_newsadd" id="ftbl_newsadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="tbl_news">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_tbl_newsadd" class="ewTable">

...
<div id="theTable" ng-core-controller>
	...
	<?php endif; ?>
	<?php if(($newAction = $table["actions"]["_new"]) && $table["createType"]=="popup"): ?>
		<div>
			<div class="text-right">
				<a href="#modal-create" data-toggle="modal" class="btn btn-danger btn-sm" style="margin-top:20px;" target="_self"><i class="icon-plus"></i> New <?php echo $table["itemLabel"] ?></a>

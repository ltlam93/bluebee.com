...
class ctbl_teacher_faculty_position_list extends ctbl_teacher_faculty_position {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_tbl_teacher_faculty_position\" href=\"javascript:void(0);\" onclick=\"ew_EmailDialogShow({lnk:'emf_tbl_teacher_faculty_position',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.ftbl_teacher_faculty_positionlist,sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
...
<?php if ($Security->IsLoggedIn()) { ?>
<a class="ewGridLink" href="" onclick="ew_SubmitSelected(document.ftbl_teacher_faculty_positionlist, '<?php echo $tbl_teacher_faculty_position_list->MultiDeleteUrl ?>', ewLanguage.Phrase('DeleteMultiConfirmMsg'));return false;"><?php echo $Language->Phrase("DeleteSelectedLink") ?></a>&nbsp;&nbsp;
<?php } ?>
<?php } ?>
</span>
</div>

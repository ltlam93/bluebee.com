...
$tbl_teacher_add = NULL; // Initialize page object first

class ctbl_teacher_add extends ctbl_teacher {
	...
	// Page object name
	var $PageObjName = 'tbl_teacher_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "tbl_teacherview.php")
	...
	function LoadDefaultValues() {
		...
		$this->teacher_personal_page->CurrentValue = NULL;
		$this->teacher_personal_page->OldValue = $this->teacher_personal_page->CurrentValue;
		$this->teacher_avatar->Upload->DbValue = NULL;
		$this->teacher_avatar->OldValue = $this->teacher_avatar->Upload->DbValue;
		$this->teacher_avatar->CurrentValue = NULL; // Clear file related field
		$this->teacher_description->CurrentValue = NULL;
		$this->teacher_description->OldValue = $this->teacher_description->CurrentValue;
		$this->teacher_work_place->CurrentValue = NULL;
		$this->teacher_work_place->OldValue = $this->teacher_work_place->CurrentValue;
		$this->teacher_active->CurrentValue = NULL;
		$this->teacher_active->OldValue = $this->teacher_active->CurrentValue;
		$this->teacher_acadamic_title->CurrentValue = NULL;
		$this->teacher_acadamic_title->OldValue = $this->teacher_acadamic_title->CurrentValue;
		$this->teacher_birthday->CurrentValue = NULL;
		$this->teacher_birthday->OldValue = $this->teacher_birthday->CurrentValue;
		$this->teacher_sex->CurrentValue = NULL;
		$this->teacher_sex->OldValue = $this->teacher_sex->CurrentValue;
		$this->teacher_faculty->CurrentValue = NULL;
		$this->teacher_faculty->OldValue = $this->teacher_faculty->CurrentValue;
		$this->teacher_dept->CurrentValue = NULL;
		$this->teacher_dept->OldValue = $this->teacher_dept->CurrentValue;
		$this->teacher_rate->CurrentValue = NULL;
		$this->teacher_rate->OldValue = $this->teacher_rate->CurrentValue;
		$this->teacher_personality->CurrentValue = NULL;
		$this->teacher_personality->OldValue = $this->teacher_personality->CurrentValue;
		$this->advices->CurrentValue = NULL;
		$this->advices->OldValue = $this->advices->CurrentValue;
		$this->teacher_research->CurrentValue = NULL;
		$this->teacher_research->OldValue = $this->teacher_research->CurrentValue;
	}
...
// Create page object
if (!isset($tbl_teacher_add)) $tbl_teacher_add = new ctbl_teacher_add();

// Page init
$tbl_teacher_add->Page_Init();

// Page main
$tbl_teacher_add->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var tbl_teacher_add = new ew_Page("tbl_teacher_add");
tbl_teacher_add.PageID = "add"; // Page ID
var EW_PAGE_ID = tbl_teacher_add.PageID; // For backward compatibility

// Form object
var ftbl_teacheradd = new ew_Form("ftbl_teacheradd");

// Validate form
ftbl_teacheradd.Validate = function(fobj) {
...
ftbl_teacheradd.Form_CustomValidate =  
...
ftbl_teacheradd.ValidateRequired = true;
<?php } else { ?>
ftbl_teacheradd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftbl_teacheradd.Lists["x_teacher_faculty"] = {"LinkField":"x_faculty_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_faculty_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
ftbl_teacheradd.Lists["x_teacher_dept"] = {"LinkField":"x_dept_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_dept_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $tbl_teacher->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $tbl_teacher->getReturnUrl() ?>" id="a_GoBack" class="ewLink"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $tbl_teacher_add->ShowPageHeader(); ?>
<?php
$tbl_teacher_add->ShowMessage();
?>
<form name="ftbl_teacheradd" id="ftbl_teacheradd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" enctype="multipart/form-data" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="tbl_teacher">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_tbl_teacheradd" class="ewTable">
...
<script type="text/javascript">
ew_CreateEditor("ftbl_teacheradd", "x_teacher_personal_page", 0, 0, <?php echo ($tbl_teacher->teacher_personal_page->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<script type="text/javascript">
ew_CreateEditor("ftbl_teacheradd", "x_teacher_description", 35, 4, <?php echo ($tbl_teacher->teacher_description->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<script type="text/javascript">
ew_CreateEditor("ftbl_teacheradd", "x_teacher_work_place", 0, 0, <?php echo ($tbl_teacher->teacher_work_place->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<script type="text/javascript">
ew_CreateEditor("ftbl_teacheradd", "x_teacher_birthday", 0, 0, <?php echo ($tbl_teacher->teacher_birthday->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<script type="text/javascript">
ftbl_teacheradd.Lists["x_teacher_faculty"].Options = <?php echo (is_array($tbl_teacher->teacher_faculty->EditValue)) ? ew_ArrayToJson($tbl_teacher->teacher_faculty->EditValue, 1) : "[]" ?>;
</script>
...
<script type="text/javascript">
ftbl_teacheradd.Lists["x_teacher_dept"].Options = <?php echo (is_array($tbl_teacher->teacher_dept->EditValue)) ? ew_ArrayToJson($tbl_teacher->teacher_dept->EditValue, 1) : "[]" ?>;
</script>
...
<script type="text/javascript">
ew_CreateEditor("ftbl_teacheradd", "x_teacher_personality", 35, 4, <?php echo ($tbl_teacher->teacher_personality->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<script type="text/javascript">
ew_CreateEditor("ftbl_teacheradd", "x_advices", 35, 4, <?php echo ($tbl_teacher->advices->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<script type="text/javascript">
ew_CreateEditor("ftbl_teacheradd", "x_teacher_research", 35, 4, <?php echo ($tbl_teacher->teacher_research->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
...
<script type="text/javascript">
ftbl_teacheradd.Init();
</script>
<?php
$tbl_teacher_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$tbl_teacher_add->Page_Terminate();
?>

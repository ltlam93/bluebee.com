...
$tbl_lesson_video = NULL;

//
// Table class for tbl_lesson_video
//
class ctbl_lesson_video extends cTable {
	var $id;
	var $lesson_id;
	var $video_link;
	var $active;
	...
	function __construct() {
		...
		$this->TableVar = 'tbl_lesson_video';
		$this->TableName = 'tbl_lesson_video';
		...
		// id
		$this->id = new cField('tbl_lesson_video', 'tbl_lesson_video', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// lesson_id
		$this->lesson_id = new cField('tbl_lesson_video', 'tbl_lesson_video', 'x_lesson_id', 'lesson_id', '`lesson_id`', '`lesson_id`', 3, -1, FALSE, '`lesson_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->lesson_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['lesson_id'] = &$this->lesson_id;

		// video_link
		$this->video_link = new cField('tbl_lesson_video', 'tbl_lesson_video', 'x_video_link', 'video_link', '`video_link`', '`video_link`', 200, -1, FALSE, '`video_link`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['video_link'] = &$this->video_link;

		// active
		$this->active = new cField('tbl_lesson_video', 'tbl_lesson_video', 'x_active', 'active', '`active`', '`active`', 3, -1, FALSE, '`active`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`tbl_lesson_video`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "tbl_lesson_videolist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("tbl_lesson_videoview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "tbl_lesson_videoadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("tbl_lesson_videoedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("tbl_lesson_videoadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("tbl_lesson_videodelete.php", $this->UrlParm());
	}
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				if ($this->video_link->Exportable) $Doc->ExportCaption($this->video_link);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					if ($this->video_link->Exportable) $Doc->ExportField($this->video_link);
